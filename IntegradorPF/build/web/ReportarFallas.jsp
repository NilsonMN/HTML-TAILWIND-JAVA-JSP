<%-- 
    Document   : ReportarFallas
    Created on : 16 jul. 2024, 15:40:57
    Author     : Nilson
--%>
        ...
        <div class="p-10" style="margin-left: 25%;">
            ...
            <div class="grid grid-cols-1 gap-8 mx-10">
                <div class="rounded px-16 py-10" style="box-shadow: 0 0 15px #a5a5a5;">
                    ...
                    <h2 name="id" class="text-lg font-bold text-blue-900 mt-4">ID del Usuario: ${id}</h2>
                    <form action="ReportarFallasServlet" method="POST">
                        ...
                        <div class="flex gap-7 my-10 px-5 text-2xl">
                            <div class="w-2/4">
                                ...
                                <select name="tipoFallo" class="rounded border-solid border-black border p-1 my-2 w-full">
                                    <option value="opcion1" placeholder="Seleccione una opción"></option>
